...
var FOLDER_PATH = exports.FOLDER_PATH = 'media/';
var DEFAULT_SORT = exports.DEFAULT_SORT = 'asc';
var PIC_PATH = exports.PIC_PATH = 'img/cover.png';
...
var initialFolder = function initialFolder() {
...
if (typeof parsed.t !== 'undefined') {
    if (store.state.folderSelected !== null) {
        if (typeof store.state.folderList[store.state.folderSelected]['files'][parsed.t] !== 'undefined') {
            var folderId = store.state.folderSelected;
            var trackId = parsed.t;
            _vue2.default.nextTick(function () {
                store.dispatch('trackPlay', { folderId: folderId, trackId: trackId });
            });
        }
    }
}
...
Component.options.__file = "D:\\Developpement\\Projets\\VueAudioPlayer\\web\\vue\\components\\App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-82540a28", Component.options)
  } else {
    hotAPI.reload("data-v-82540a28", Component.options)
  }
...
var _RepFolderList = __webpack_require__(23);

var _RepFolderList2 = _interopRequireDefault(_RepFolderList);

var _RepTrackList = __webpack_require__(25);

var _RepTrackList2 = _interopRequireDefault(_RepTrackList);

var _RepPlayer = __webpack_require__(24);

var _RepPlayer2 = _interopRequireDefault(_RepPlayer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
    components: {
        RepFolderList: _RepFolderList2.default,
        RepTrackList: _RepTrackList2.default,
        RepPlayer: _RepPlayer2.default
    }
}; //
//
//
...
exports.default = {
    data: function data() {
        return {
            sort: this.$cookie.get('rep_sort') || _config.DEFAULT_SORT
        };
    },
...
var _aplayer = __webpack_require__(11);
...
exports.default = {
    ...
    methods: {
        ...
        copyFolderAction: function copyFolderAction() {
            return baseUrl + '?f=' + this.folderSelected;
        },
        copyAction: function copyAction(key) {
...
var VueCookie = __webpack_require__(9);
...
var decodeComponent = __webpack_require__(17);
...
Component.options.__file = "D:\\Developpement\\Projets\\VueAudioPlayer\\web\\vue\\components\\RepFolderList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] RepFolderList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-76fdf098", Component.options)
  } else {
    hotAPI.reload("data-v-76fdf098", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "D:\\Developpement\\Projets\\VueAudioPlayer\\web\\vue\\components\\RepPlayer.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] RepPlayer.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0572dde9", Component.options)
  } else {
    hotAPI.reload("data-v-0572dde9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "D:\\Developpement\\Projets\\VueAudioPlayer\\web\\vue\\components\\RepTrackList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] RepTrackList.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-360defb1", Component.options)
  } else {
    hotAPI.reload("data-v-360defb1", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0572dde9", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('table', {
  ...
  }, [(_vm.folderSelected && _vm.linkCopy === _vm.folder.dir) ? _c('span', {
    staticClass: "icon-copy glyphicon glyphicon-ok",
    attrs: {
      "aria-hidden": "true"
    }
  }) : _vm._e()]), _vm._v(" "), (_vm.folderSelected && Object.keys(_vm.folder.files).length > 0) ? _c('button', {
    directives: [{
      name: "clipboard",
      rawName: "v-clipboard",
      value: (_vm.copyFolderAction),
      expression: "copyFolderAction"
    }],
    key: _vm.folder.dir,
    ...
    on: {
      "success": function($event) {
        _vm.handleSuccess(_vm.folder.dir)
      }
    }
  }, [_c('span', {
    ...
    on: {
      "click": function($event) {
        _vm.folderPlay(_vm.folderSelected)
      }
    }
  }, [_c('span', {
  ...
  }), _vm._v(" Play all")]) : _vm._e()], 1)])]), _vm._v(" "), _c('tbody', [(_vm.folder == null) ? _c('tr', [_c('td', {
    staticClass: "text-center",
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("Choose a folder")])]) : (Object.keys(_vm.folder.files).length == 0) ? _c('tr', [_c('td', {
    staticClass: "text-center",
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("No files in this folder !")])]) : _vm._l((_vm.folder.files), function(entry, key) {
    return _c('tr', {
      on: {
        "click": function($event) {
          _vm.trackPlay(_vm.folderSelected, key)
        }
      }
    }, [_c('td', {
      staticClass: "folder-name clickable"
    }, [_vm._v(_vm._s(entry.file))]), _vm._v(" "), _c('td', {
      staticClass: "text-right clickable"
    }, [_c('transition', {
      attrs: {
        "name": "fadecopy"
      }
    }, [(_vm.folderSelected && _vm.linkCopy === key) ? _c('span', {
      staticClass: "icon-copy glyphicon glyphicon-ok",
      attrs: {
        "aria-hidden": "true"
      }
      ...
      directives: [{
        name: "clipboard",
        rawName: "v-clipboard",
        value: (_vm.copyAction(key)),
        expression: "copyAction(key)"
      }],
      key: key,
      staticClass: "btn btn-default btn-xs",
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-360defb1", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('table', {
    ...
    class: {
      caret: true, 'caret-up': _vm.sort == 'asc'
    }
  })]), _vm._v(" "), _c('th', {
    staticClass: "text-center",
    attrs: {
  ...
  }, [_vm._v(_vm._s(Object.keys(_vm.folders).length))]), _vm._v(" "), _c('th', {
    staticClass: "text-right",
    attrs: {
      "width": "35%"
    }
  }, [(_vm.folders) ? _c('button', {
    staticClass: "btn btn-default btn-xs",
    attrs: {
      "type": "button"
    },
  ...
  }), _vm._v(" Play all")]) : _vm._e()])])]), _vm._v(" "), _c('tbody', _vm._l((_vm.folders), function(entry, key) {
    return _c('tr', {
      class: {
        'bg-primary': key == _vm.folderSelected
      }
    }, [_c('td', {
      staticClass: "clickable folder-name",
      on: {
        "click": function($event) {
          _vm.folderView(key)
        }
      }
    }, [_vm._v(_vm._s(entry.dir))]), _vm._v(" "), _c('td', {
      staticClass: "clickable text-center",
      on: {
        "click": function($event) {
          _vm.folderView(key)
        }
      }
    }, [_vm._v(_vm._s(Object.keys(entry.files).length))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [_c('button', {
      staticClass: "btn btn-default btn-xs hidden-xs",
      attrs: {
        "type": "button"
      },
      on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-76fdf098", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "col-xs-12 col-sm-12 col-md-6 col-lg-4 app-panel"
  }, [_c('div', {
    staticClass: "folder-panel"
  }, [_c('rep-folder-list')], 1)]), _vm._v(" "), _c('div', {
    staticClass: "col-xs-12 col-sm-12 col-md-6 col-lg-offset-4 col-lg-4 app-panel"
  }, [_c('rep-track-list')], 1), _vm._v(" "), _c('div', {
    staticClass: "col-xs-12 col-sm-12 col-md-6 col-md-push-6 col-lg-offset-8 col-lg-4 app-panel"
  }, [_c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-82540a28", module.exports)
  }
}
